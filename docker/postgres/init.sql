...
-- Test Runs (Both functional and load runs)
CREATE TABLE IF NOT EXISTS test_runs (
    id VARCHAR(64) PRIMARY KEY,
    workspace_id VARCHAR(64) NOT NULL REFERENCES workspaces(id) ON DELETE CASCADE,
    collection_id VARCHAR(64) REFERENCES collections(id) ON DELETE SET NULL,
    name VARCHAR(255) NOT NULL,
    type VARCHAR(32) NOT NULL, -- 'functional', 'load', 'data_driven'
...
-- Granular Test Results (Functional step assertions / sample records)
...
-- Scheduled Runs (Cron automation)
